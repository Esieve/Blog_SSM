    ...
    var g = [CKEDITOR.ALT, CKEDITOR.SHIFT,
        ...
        return function (a, d) {
            ...
            if (b[d]) {
                c = b[d];
                for (var k, l, m = [],
                         f = 0; f < g.length; f++)l = g[f], k = c / g[f], 1 < k && 2 >= k && (c -= l, m.push(e[l]));
    ...
    return {
        title: a.title, minWidth: 600, minHeight: 400, contents: [{
            id: "info", label: h.lang.common.generalTab, expand: !0, elements: [{
                ...
                html: function () {
                    for (var b = '\x3cdiv class\x3d"cke_accessibility_legend" role\x3d"document" aria-labelledby\x3d"' + n + '_arialbl" tabIndex\x3d"-1"\x3e%1\x3c/div\x3e\x3cspan id\x3d"' + n + '_arialbl" class\x3d"cke_voice_label"\x3e' + a.contents + " \x3c/span\x3e",
                             e = [], d = a.legend, h = d.length, g = 0; g < h; g++) {
